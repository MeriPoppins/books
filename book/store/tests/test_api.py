...
from store.selializers import BooksSerializer
...
class BooksApiTestCase(APITestCase):
    ...
    def test_get_list(self):
        ...
        serializer_data = BooksSerializer(books, many=True).data  # many - сериализовть каждый элемент
        self.assertEqual(status.HTTP_200_OK, response.status_code)  # с чем сравниваем и что сравниваем
        self.assertEqual(serializer_data, response.data)
